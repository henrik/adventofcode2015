# This is very similar to day 9; even the number of nodes (8) and thus the number of possible permutations (8! = 40 320).
# Since the number is low, we can happily brute-force it.
